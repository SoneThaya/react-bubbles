...
A token is used to authenticate a client.  Give the client access to site.

- [ ] What steps can you take in your web apps to keep your data secure?

Backup data. Scan website for vulnerabilities. Keep everything up to date. Have a strong password policy. Use a secure host. Firewall.


- [ ] Describe how web servers work.

A web server process incoming network requests over HTTP. Primary function of a web server is to store, process and deliver web pages to clients. Communication between a client and a server is HTTP.
